...
import {faCopy, faFloppyDisk, faPaperPlane, faSpinner } from '@fortawesome/free-solid-svg-icons';
  ...
  async function run() {
    ...
    try {
      ...
      if (result.response) {
        ...
        setAnswer("I couldn't understand your question. Please try rephrasing it.");
      }
    } catch (error) {
    ...
    <div className="App">
      <div>
        <header className="p-5">
          <Navbar saveChat={saveChat} setSaveChat={setSaveChat} setSaveQuestion={setSaveQuestion} setAnswer={setAnswer} />
        </header>
